...
(deftest generate-at
  ...
  (is (= 146373 (time (apply max (vals (last (take 7999 (map :scores (problem9/generate 13 0)))))))))
  ...
  ;(is (= 37305 (apply max (vals (last (take 72170 (map :scores (problem9/generate 470))))))))
  )
